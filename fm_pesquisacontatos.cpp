    ...
    ui(new Ui::fm_pesquisacontatos)
{
    ...
    if (query.exec())
    {
       ...
       ui->tw_contatos->setColumnWidth(3,250);
       ...
       ui->tw_contatos->setStyleSheet("QTableView{selection-background-color:red}");
    }
    else {
        QMessageBox::warning(this,"ERROR", "Erro ao pesquisar na tabela de contatos");
    }
}
